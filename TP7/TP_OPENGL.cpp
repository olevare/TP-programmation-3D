...
void TP7()
{
  ...
  //exercice 1
  //mesh.buildCylinder(10, 30, meridiens);
  //mesh.buildSphere(10, meridiens, meridiens);

  //exercice 2
  //mesh.buildCylinder(5, 50, meridiens);
  //mesh.buildSphere(10, meridiens, meridiens);
  //mesh.drawImageGaussian(10);

  //exercice 3
  mesh.buildCylinder(10, 30, meridiens);
  mesh.initDiedreArray();
  mesh.drawEdgesDiedre(180);
