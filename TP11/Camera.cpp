...
void Camera::setSensi(double sensi)
{
}

void Camera::setSpeed(double z)
{
...
void Camera::events(bool left,bool right,bool up,bool down,bool fw,bool bw,bool mv,Vector v_mv)
{
